...
// Store provides all functions to execute transactions
type Store struct {
	*Queries // calling *Queries directly is a way to perform inheritance.
	db       *sql.DB
}
...
func addMoney(
	...
	if err != nil {
		return // could be writen as return because we are reclaring the return variables before
	}
